...
***************************************************************************** */
        ...
        var external_commonjs_vue_commonjs2_vue_root_Vue_amd_vue_default = /*#__PURE__*/ __webpack_require__.n(
                          ...
                          [
                                      ...
                                      return _this7.renderSlot(
                                        ...
                                        h(
                                          'vue-slider-mark',
                                          {
                                            ...
                                            vue_slider_defineProperty(
                                              _style,
                                              _this7.isHorizontal ? 'width' : 'height',
                                              _this7.tailSize,
                                            ),
                                            vue_slider_defineProperty(
                                              _style,
                                          ...
                                          [
                                            _this7.renderSlot('step', mark, null),
                                            _this7.renderSlot('label', mark, null),
                                          ],
                                        ),
                                        true,
                                      )
                            ...
                            this.dots.map(function(dot, index) {
                              ...
                              return h(
                                  ...
                                  attrs: vue_slider_objectSpread(
                                    {
                                      ...
                                      'tooltip-formatter': Array.isArray(
                                        ...
                                        ? _this7.sliderTooltipFormatter[index]
                                        : _this7.sliderTooltipFormatter,
                                      ...
                                      'aria-orientation': _this7.isHorizontal
                                        ? 'horizontal'
                                        : 'vertical',
                                      tabindex: '0',
                                    },
                                ...
                                [
                                  _this7.renderSlot('dot', dot, null),
                                  _this7.renderSlot('tooltip', dot, null),
                                ],
                              )
                            }),
                            this.renderSlot(
                      ...
                      return {
                        ...
                        style: vue_slider_objectSpread(
                          vue_slider_objectSpread(
                            ...
                            vue_slider_defineProperty(
                              _objectSpread2,
                              _this8.isHorizontal ? 'height' : 'width',
                              '100%',
                            ),
                            vue_slider_defineProperty(
                              _objectSpread2,
                              _this8.isHorizontal ? 'top' : 'left',
                              0,
                            ),
                            vue_slider_defineProperty(
                              _objectSpread2,
                              _this8.mainDirection,
                              ''.concat(start, '%'),
                            ),
                            vue_slider_defineProperty(
                              _objectSpread2,
                            ...
                            vue_slider_defineProperty(
                              _objectSpread2,
                              'transitionProperty',
                              ''.concat(sizeStyleKey, ',').concat(_this8.mainDirection),
                            ),
                            vue_slider_defineProperty(
                              _objectSpread2,
                              'transitionDuration',
                              ''.concat(_this8.animateTime, 's'),
                            ),
                            _objectSpread2),
                            _this8.processStyle,
                          ),
                      ...
                      return vue_slider_objectSpread(
                        {
                          ...
                          focus:
                            _this9.states.has(SliderState.Focus) && _this9.focusDotIndex === index,
                          disabled: _this9.disabled,
                          style: _this9.dotStyle,
                        },
                        (Array.isArray(_this9.dotOptions)
                          ? _this9.dotOptions[index]
                          : _this9.dotOptions) || {},
                      )
                    })
                  },
